...
| [`references/auditing.md`](references/auditing.md) | Auditing a theme you inherited for hard-coded colours and orphaned tokens, and auditing the rendered page across seven scored dimensions with a P0/P1/P2 punch list |
